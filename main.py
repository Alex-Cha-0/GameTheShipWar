...
class Ship:
    ...
    """
    def __init__(self, bow, len_ship, orientation):
        self.bow_dot = bow
    ...
    def shooten(self, shot):
        """
        Метод показывающий попадание в корабль
        :param shot:
        :return:
        """
...
class Board:
    ...
    def add_ship(self, ship):
        """
        Метод добаления корабля на поле
        :param ship:
        :return:
        """
        for d in ship.dots:
    ...
    def contour(self, ship, verb=False):
        """
        Метод обводки корабля по контуру
        :param ship:
        :param verb:
        :return:
        """
    ...
    def out(self, d):
        ...
        :return:
        """
        return not ((0 <= d.x < self.size_board) and (0 <= d.y < self.size_board))
